...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    expect(multiply(-15,21)).to eq(-315)
  end

  it "multiplies zero properly" do
    expect(multiply(0,999999999999999)).to eq(0)
  end

  it "multiplies several numbers" do
    expect(multiply([25,10,15,-5])).to eq(-18750)
  end
